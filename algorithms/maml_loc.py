...
class MAMLConfigLoc(AlgorithmConfig):
    ...
    def __init__(self, algo_class=None):
        ...
        super().__init__(algo_class=algo_class or MAMLLoc)
...
class MAMLLoc(Algorithm):
    @classmethod
    @override(Algorithm)
    def get_default_config(cls) -> AlgorithmConfig:
        return MAMLConfigLoc()
    ...
    def get_default_policy_class(
        ...
        if config["framework"] == "torch":
            from algo_ray.rllib.algorithms.maml.maml_torch_policy import MAMLTorchPolicy
...
class _deprecated_default_config(dict):
    def __init__(self):
        super().__init__(MAMLConfigLoc().to_dict())

    @Deprecated(
        old="ray.rllib.algorithms.maml.maml.DEFAULT_CONFIG",
        new="ray.rllib.algorithms.maml.maml.MAMLConfigLoc(...)",
        error=True,
    )
